...
> 不同批次的数据截止日期不同，价格、额度和产品状态请以对应材料标注日期为准。
...
| 2026 年 8–9 月 | AI 订阅与 Harness 工具生态对比 | 24 页 PPT 工程 + 视频脚本 | 2026-08 | [查看工程](./ai-subscription-harness/) |

## 2026 年 7–8 月：Coding Plan、Token Plan 与会员体系

覆盖 13 类产品与服务，按以下产品形态分组，而不是把不同口径的额度强行折算：

- Coding Agent / AI IDE 订阅
- API Token 或模型调用套餐
- 通用大模型会员
- 本地模型及云端增值服务
- 混合型产品
...
| `ai-subscription-harness/style-guide.md` | 视觉规范（配色、字体、版式坐标） |
| `docs/视频讲解脚本框架.md` | 配套视频逐页口播脚本、金句库与切片建议 |
| `plan.md` | 项目执行计划 |
...
- 仓库中的产品名称、Logo 和商标归各自权利人所有，仅用于识别、评论与比较。
- CC BY 4.0 仅授权本仓库作者有权许可的原创内容，不授予任何第三方商标权。
